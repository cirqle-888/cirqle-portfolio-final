      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Delivering highly efficient turn-around times while maintaining premium visual aesthetics. Our supermarket flyer workflows redefine volume output.
          </p>
        </motion.div>
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-medium mb-10 text-center">Campaign Focus</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {["Volume Deliverables", "Brand Consistency", "Fast Turnarounds"].map((item, i) => (
              <div key={i} className="liquid-glass-card p-8 rounded-3xl edge-glow-hover transition-all">
                ...
                <p className="text-gray-600">Built to handle massive promotional output needs without scaling back on the creative edge.</p>
              </div>
            ))}
          </div>
        </section>
        ...
        >
          ...
          <div className="relative z-10 px-6">
            <h2 className="text-4xl font-medium mb-6">Want flyer quality like this?</h2>
